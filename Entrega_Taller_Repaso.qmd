...
region_paises <- list(
  "America Latina" = c("Argentina", "Bolivia", "Brazil", "Chile", "Colombia", "Costa Rica", "Cuba", 
                      ...
                      "Belize", "Guyana", "Suriname", "Saint Kitts and Nevis", 
                      "Saint Lucia", "Saint Vincent and the Grenadines", "Grenada"),
  "America del Norte" = c("United States", "Canada", "Mexico", "Bermuda", "Greenland", "Saint Pierre and Miquelon"),
  ...
  "Africa" = c("Nigeria", "Ethiopia", "Egypt", "DR Congo", "Tanzania", "South Africa", "Kenya", 
               ...
               "Namibia", "Gambia", "Botswana", "Gabon", "Lesotho", "Eswatini", "Guinea-Bissau", 
